...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
						<input id="birthday" type="date" max="<?php echo date("Y-m-d"); ?>" class="form-control <?php $__errorArgs = ['birthday'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\zeroWaste\example\resources\views/auth/register.blade.php ENDPATH**/ ?>
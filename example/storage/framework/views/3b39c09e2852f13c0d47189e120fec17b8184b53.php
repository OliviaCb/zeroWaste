        ...
        <div class="col-md-8"> -->
            ...
            <link rel="stylesheet" href="<?php echo e(asset('css/jakis.css')); ?>" />
                ...
                <div class="row align-items-center">
                    <div class="col-md-6"><img src="<?php echo e(asset('uploads/recipes/Lunch Break_Isometric.png')); ?>" alt="" srcset=""></div>
               
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header"><?php echo e(__('Logowanie do aplikacji')); ?></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bukow\Documents\GitHub\zeroWaste\example\resources\views/auth/login.blade.php ENDPATH**/ ?>
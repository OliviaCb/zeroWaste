        ...
        <div class="col-md-8">
            ...
            <div class="rejestracja">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-header"><?php echo e(__('Zarejestruj nowego użytkownika')); ?></div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?php echo e(route('register')); ?>">
                                    ...
                                    <div class="row mb-3">
                                        <label for="name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Nick użytkownika')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row mb-3">
                                        <label for="firstname" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Imię')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row mb-3">
                                        <label for="surname" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Nazwisko')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row mb-3">
                                        <label for="birthday" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Data urodzenia')); ?></label>

                                        <div class="col-md-6">
                                            <input id="birthday" type="date" min="<?php echo date('Y-m-d', strtotime('-150 year')); ?>" max="<?php echo date("Y-m-d"); ?>" class="form-control <?php $__errorArgs = ['birthday'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-5"><img src="<?php echo e(asset('uploads/recipes/Chef_Isometric.png')); ?>" alt="" srcset=""></div>
            </div>
            <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bukow\Documents\GitHub\zeroWaste\example\resources\views/auth/register.blade.php ENDPATH**/ ?>